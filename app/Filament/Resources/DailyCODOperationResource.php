    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            ...
            Forms\Components\TextInput::make('order_code')
                ->label('Order Code')
                ->helperText('Optional: external order reference'),
            ...
            Forms\Components\Select::make('product_id')
                ...
                ->afterStateUpdated(function ($state, callable $set) {
                    ...
                    $set(
                        ...
                        $product->return_loss_estimate > 0 &&
                        $product->expected_courier_cost > 0
                            ? round(
                                ($product->return_loss_estimate / $product->expected_courier_cost) * 100,
                                2
                            )
                            : 0
                    );
                    ...
                    $set('expected_profit', round($expectedProfit, 2));
                }),
            ...
            Forms\Components\TextInput::make('courier_cost')
                ->numeric()
                ->required(),
            ...
            Forms\Components\TextInput::make('actual_profit')
                ->numeric()
                ->disabled()
                ->dehydrated(false),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                Tables\Columns\TextColumn::make('actual_profit')
                    ->money('LKR')
                    ->sortable(),
