    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            ...
            Forms\Components\Select::make('finance_category_id')
                ...
                ->searchable()
                ->required()
                ->helperText('Categories are filtered by type to keep operational finance tagging consistent.'),
            Forms\Components\TextInput::make('amount')->numeric()->required(),
            Forms\Components\TextInput::make('payment_method'),
            Forms\Components\TextInput::make('reference_no'),
            Forms\Components\Textarea::make('description'),
            Forms\Components\Placeholder::make('finance_scope_note')
                ->content('HELOS Finance is for operational money visibility (income, direct costs, and monthly overhead). It is not a full accounting/ERP ledger.'),
