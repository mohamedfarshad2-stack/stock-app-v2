...
class HELOSImportCenter extends Page implements HasForms
{
    ...
    protected function getFormSchema(): array
    {
        return [
            ...
            Forms\Components\Select::make('import_profile')
                ...
                ->default('auto')
                ->helperText('Keeps current workflow intact. Auto mode uses existing behavior and logs detected profile.'),
    ...
    public function importCategories(): void
    {
        ...
        $this->form->fill(['category_file' => null, 'import_profile' => $context['profile'], 'import_business_unit_id' => $context['business_unit_id']]);
    }
    ...
    private function getImportContext(): array
    {
        ...
        if ($profile === 'auto') {
            // current import behavior remains finance-first; this flags future business-unit routing safely
            $profile = 'finance';
        }
