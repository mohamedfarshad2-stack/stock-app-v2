...
return [
   ...
   App\Filament\Widgets\CODDashboardStats::class,
App\Filament\Widgets\RiskyAreasWidget::class,
App\Filament\Widgets\HighRiskOrdersWidget::class,
App\Filament\Widgets\CODProfitWidget::class,
